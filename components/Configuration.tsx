...
const Configuration: React.FC<ConfigurationProps> = ({ paddingLength, setPaddingLength, disabled }) => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 mb-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <label htmlFor="padding" className="text-sm font-medium text-slate-600">
        ...
        <div className="relative">
          ...
          />
          <span className="absolute right-[-140px] top-2 text-xs text-slate-400 pointer-events-none">
